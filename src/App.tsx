...
const questions: Question[] = [
  ...
  },
  {
    id: 3,
    topic: 'Kiến trúc thượng tầng',
    title: 'Theo triết học Mác – Lênin, yếu tố nào quyết định kiến trúc thượng tầng?',
  ...
  },
  {
    ...
    options: ['Kìm hãm xã hội phát triển', 'Thúc đẩy kinh tế phát triển', 'Làm xã hội trì trệ', 'Không ảnh hưởng gì'],
    correct: 'B',
  },
  {
    id: 5,
    ...
    options: ['Thúc đẩy sản xuất', 'Làm tăng năng suất lao động', 'Kìm hãm sự phát triển kinh tế', 'Không tác động đến xã hội'],
    correct: 'C',
  },
  {
    id: 6,
    topic: 'Quan hệ kinh tế - chính trị',
    title: 'Mối quan hệ giữa cơ sở hạ tầng và kiến trúc thượng tầng thực chất là:',
    options: ['Quan hệ văn hóa và giáo dục', 'Quan hệ kinh tế và chính trị', 'Quan hệ dân số và môi trường', 'Quan hệ pháp luật và đạo đức'],
    correct: 'B',
  },
  {
    id: 7,
    ...
    options: ['Văn học nghệ thuật', 'Tôn giáo', 'Hệ thống chính trị và pháp luật', 'Phong tục tập quán'],
    correct: 'C',
  },
  {
    id: 8,
    ...
    options: ['Chủ nghĩa tư bản', 'Chủ nghĩa dân tộc', 'Chủ nghĩa Mác – Lênin và tư tưởng Hồ Chí Minh', 'Chủ nghĩa tự do'],
    correct: 'C',
  },
  {
    id: 9,
    ...
    options: ['Nhà nước tư sản', 'Nhà nước quân chủ', 'Nhà nước của dân, do dân, vì dân', 'Nhà nước phong kiến'],
    correct: 'C',
  },
  {
    id: 10,
    ...
    options: ['Đổi mới chính trị là trung tâm', 'Đổi mới văn hóa là trung tâm', 'Đổi mới kinh tế là trung tâm', 'Quốc phòng là trung tâm'],
    correct: 'C',
  },
  {
    id: 11,
    ...
    options: ['Thiên nhiên', 'Đường lối, chính sách của Đảng và Nhà nước', 'Hoạt động tôn giáo', 'Tập quán xã hội'],
    correct: 'B',
  },
  {
    id: 12,
    ...
    options: ['Kinh tế không liên quan đến chính trị', 'Chính trị là biểu hiện tập trung của kinh tế', 'Chính trị quyết định hoàn toàn kinh tế', 'Chính trị và kinh tế tách rời nhau'],
    correct: 'B',
  },
  {
    id: 13,
    ...
    options: ['Xã hội phong kiến', 'Cơ sở hạ tầng tư bản chủ nghĩa', 'Cơ sở hạ tầng xã hội chủ nghĩa', 'Nền kinh tế tự nhiên'],
    correct: 'C',
  },
  {
    id: 14,
    ...
    options: ['Quốc hội', 'Nhân dân', 'Đảng Cộng sản Việt Nam', 'Doanh nghiệp tư nhân'],
    correct: 'C',
  },
  {
    id: 15,
  ...
  },
  {
    id: 16,
    topic: 'Kỷ luật lao động',
    title: 'Giai cấp nào cùng tầng lớp trí thức làm nền tảng của Nhà nước XHCN Việt Nam?',
  ...
  },
  {
    ...
    options: ['Nhận thức đúng quan hệ giữa kinh tế và chính trị', 'Chỉ tập trung vào văn hóa', 'Phủ nhận vai trò kinh tế', 'Tách rời kinh tế với chính trị'],
    correct: 'A',
  },
  {
    id: 18,
  ...
  },
  {
    ...
    options: ['Nóng vội, cấp tốc', 'Thận trọng, vững chắc', 'Không cần đổi mới', 'Hoàn toàn tự phát'],
    correct: 'B',
  },
  {
    id: 20,
    ...
    options: ['Một xu hướng duy nhất', 'Hai xu hướng tích cực và tiêu cực', 'Ba xu hướng', 'Không có xu hướng nào'],
    correct: 'B',
  },
  {
    id: 21,
    ...
    options: ['Quan hệ sản xuất', 'Lực lượng sản xuất', 'Nhà nước', 'Công cụ lao động'],
    correct: 'C',
  },
  {
    id: 22,
    ...
    options: ['Cản trở kinh tế', 'Thúc đẩy phát triển kinh tế', 'Làm giảm sản xuất', 'Không ảnh hưởng đến kinh tế'],
    correct: 'B',
  },
  {
    id: 23,
    ...
    options: ['Xóa bỏ CNXH', 'Giữ vững định hướng xã hội chủ nghĩa', 'Phát triển chủ nghĩa phong kiến', 'Loại bỏ kinh tế thị trường'],
    correct: 'B',
  },
  {
    id: 24,
...
function App() {
  ...
  const luckySet = useMemo(() => {
    const picks = shuffle(Array.from({ length: TOTAL_CELLS }, (_, index) => index + 1))
  ...
  const [selectedOption, setSelectedOption] = useState<Question['correct'] | null>(null)
  ...
  const handleSpin = () => {
    ...
    const targetAngle = 360 - (pickNumber - 1) * segmentAngle - segmentAngle / 2
          ...
          <section className="game-shell" id="game">
            <div className="game-header">
              <div>
                ...
                <p>Click từng ô để mở câu hỏi hoặc ô may mắn. Ô đã chọn sẽ được đánh dấu.</p>
              </div>
            </div>
            ...
            <div className="wheel-panel" aria-label="Vòng quay may mắn">
              <div className="wheel-text">
                ...
                <p>Quay để lấy số ngẫu nhiên. Số đã trúng sẽ bị loại khỏi vòng quay.</p>
            ...
            <div className="board-grid" role="grid" aria-label="Lưới mini game 30 ô">
              {board.map((cell, index) => {
                const isSelected = selected.has(cell.id)
                const [toneA, toneB] = palette[index % palette.length]
                const iconLabel = isSelected ? (cell.kind === 'lucky' ? '🍀' : 'Q') : '🎴'
                return (
                  <button
                    key={cell.id}
                    type="button"
                  ...
                  >
                    <span className="cell-inner">
                      <span className="cell-front">
                        <span className="cell-index">{cell.id.toString().padStart(2, '0')}</span>
          ...
          <div className="modal-card">
            ...
            {activeCell.kind === 'lucky' ? (
              <div className="lucky-content">
                ...
                <h3>Ô may mắn</h3>
                <p>Bạn vừa mở một ô may mắn! Hãy chia sẻ một ví dụ thực tế thú vị cho nhóm.</p>
              </div>
            ) : (
              <div className="question-content">
                <div className="question-meta">{activeCell.question?.topic}</div>
                ...
                {selectedOption && (
                  ...
                  >
                    {isAnswerCorrect ? 'Chính xác!' : 'Sai rồi, thử chọn đáp án khác.'}
                  </div>
                )}
              </div>
            )}
          </div>
          <button type="button" className="modal-backdrop" onClick={closeModal} aria-label="Đóng" />
        </div>
      )}
